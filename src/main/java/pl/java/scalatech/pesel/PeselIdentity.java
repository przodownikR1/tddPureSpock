...
public final class PeselIdentity {
    ...
    public String getBirthDate() {
        int day = parseInt(matches.group(DAY));
        int year = parseInt(matches.group(YEAR));
        int month = parseInt(matches.group(MONTH));
    ...
    public Gender getGender() {
        return parseInt(matches.group(SEX)) % 2 == 1 ? Gender.MALE : Gender.FEMALE;
    }
